                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+621234567890"><i class="fa fa-phone"></i> +62-1234567890</a></li>
                            <li><a href="mailto:contact@surfsidemedia.in"><i class="fa fa-envelope"></i>
                                    contact@surfsidemedia.id</a></li>
                        </ul>
                        <ul class="visible-xs visible-sm">
                            <li class="text-left"><a href="tel:+621234567890"><i class="fa fa-phone"></i>
                                    +62-1234567890</a></li>
                            <li class="text-right"><a href="index.php/changelocation.html"><i
                                        class="fa fa-map-marker"></i> Mamat, Surahmat</a></li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-right">
                            <li><i class="fa fa-comment"></i> Live Chat</li>
                            <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Mamat,
                                    Surahmat</a></li>
                        </ul>
                    </div>
                </div>
                    ...
                    @if (Route::has('login'))
                        @auth
                            ...
                            @elseif (Auth::user()->utype === 'SVP')
                                <li class="login-form">
                                    <a href="#" title="Register">My Account (Service Provider)</a>
                                    <ul class="drop-down one-column hover-fade">
                    ...
                    <div class="row visible-md visible-lg">
                        ...
                        <div class="col-md-3 col-xs-6 col-sm-6">
                            ...
                            <ul class="contact_footer">
                                <li class="location">
                                    <i class="fa fa-map-marker"></i> <a href="#"> Mamat, Surahmat, Indonesia</a>
                                </li>
                                <li>
                                    <i class="fa fa-envelope"></i> <a
                                        href="mailto:contact@surfsidemedia.in">contact@surfsidemedia.id</a>
                                </li>
                                <li>
                                    <i class="fa fa-headphones"></i> <a href="tel:+621234567890">+62-1234567890</a>
                                </li>
                            </ul>
                    ...
                    <div class="row visible-sm visible-xs">
                        <div class="col-md-6">
                            ...
                            <ul class="contact_footer mlist">
                                ...
                                <li>
                                    <i class="fa fa-phone"></i> <a href="tel:+621234567890">+62-1234567890</a>
                                </li>
                            </ul>
